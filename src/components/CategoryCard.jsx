...
const CategoryCard = (props) => {
  ...
  return (
    <a
      className={`rounded-lg bg-[${bgcolour}] bg-cover hover:bg-[url('../assets/images/bg-hover.jpg')] min-w-[230px] h-[172px] hover:scale-105 text-center max-w-[155px] flex flex-col items-center justify-center duration-500 cursor-pointer relative transition-[all_2000ms_ease] before:bg-[url('assets/bg-hover.jpg')] before:absolute before:top-0 before:left-0 before:w-full before:h-full hover:z-0 before:bg-cover before:opacity-0 before:z-[-10] before:transition-[opacity_2s_ease] hover:before:opacity-10 over`}
    >
      {icon[title]}
