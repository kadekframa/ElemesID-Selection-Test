...
const BottomNavbar = (props) => {
  ...
  return (
    <>
      {bottomNavbarDisplay ? (
        <div className="fixed w-full left-0 border border-gray-50 flex md:hidden justify-between items-center px-6 py-2 bg-white bottom-0 duration-500">
        ...
        <div className="fixed w-full left-0 border border-gray-50 flex md:hidden justify-between items-center px-6 py-2 bg-white bottom-[-76px] duration-500">
          <button className="flex flex-col items-center px-3 py-1 text-[#757575]">
            <HumbergerIcon />
            <span className="text-xs">Home</span>
          </button>
